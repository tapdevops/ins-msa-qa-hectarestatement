...
/* 
*Find All Valid and Invalid Block	
*/
exports.findAllRaw = (req, res) => {
	BlockModel.find({})
		.select({
			_id: 0,
			REGION_CODE: 1,
...
exports.find_one_geom = (req, res) => {
	...
	if (FS.existsSync(geometry_file_location)) {
		...
		var data_geometry = GeoJSONPrecision.parse(JSON.parse(FS.readFileSync(geometry_file_location)), 6);
